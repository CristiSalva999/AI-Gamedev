...
const PREFABS: Record<PrefabKind, PrefabFactory> = {
  ...
  /** Compact stylized dwarf — bright tunic + beard so hunt targets read at range. */
  dwarf: () => ({
    kind: "dwarf",
    shape: "cylinder",
    color: "#c45c26",
    size: { x: 1.0, y: 1.7, z: 1.0 },
    roughness: 0.7,
    metalness: 0.08,
    parts: [
      {
      ...
      },
      {
        shape: "cylinder",
        color: "#d35400",
        size: { x: 0.85, y: 0.75, z: 0.7 },
        offset: { x: 0, y: 0.95, z: 0 },
        roughness: 0.65,
        materialHint: { family: "paint" },
      },
      {
        shape: "sphere",
        color: "#e0b089",
      ...
      },
      {
        shape: "box",
        color: "#6b3a1f",
        size: { x: 0.55, y: 0.35, z: 0.25 },
        offset: { x: 0, y: 1.28, z: 0.22 },
        roughness: 0.9,
        materialHint: { family: "wood" },
      },
      {
        shape: "cylinder",
        color: "#2c3e50",
        size: { x: 0.62, y: 0.28, z: 0.62 },
        offset: { x: 0, y: 1.78, z: 0 },
        roughness: 0.45,
        metalness: 0.35,
        materialHint: { family: "metal" },
      },
      {
        shape: "box",
        color: "#8e44ad",
        size: { x: 0.2, y: 0.85, z: 0.2 },
        offset: { x: 0.55, y: 0.85, z: 0 },
        roughness: 0.55,
      },
    ],
  }),
